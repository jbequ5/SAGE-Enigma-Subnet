...
4. Include meta-lessons that generalize across challenges, especially mycelial adaptation or symbiosis patterns.
5. Identify concrete policy updates for memory_policy_weights, killer_base.md, brain/ components, and model routing.
...
OUTPUT EXACT SCHEMA (JSON only, no extra text):
{
  ...
  "policy_updates": ["specific prompt / routing / tool / weight / brain component changes"],
